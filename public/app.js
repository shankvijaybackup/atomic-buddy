                    ...
                    <div className="space-y-6">
                        {analysis ? (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-6">
                                    {[
                                        { key: 'direct', title: 'Direct & Technical Approach', description: 'Focus on technical solutions and operational efficiency' },
                                        { key: 'formal', title: 'Formal & Enterprise Approach', description: 'Emphasize scalability and business alignment' },
                                        { key: 'personalized', title: 'Personalized & Relational Approach', description: 'Build connection through shared interests and challenges' }
                                    ].map((option) => {
                                        // For now, show the same content for all options since backend returns single response
                                        // In future, backend can generate different versions
                                        return (
