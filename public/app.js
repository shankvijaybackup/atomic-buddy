                                    ...
                                    {[
                                        ...
                                        <div key={option.key} className="bg-white rounded-xl shadow-md p-6">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    <div className="space-y-3 text-sm">
                                                        <div>
                                                            <div className="flex items-center justify-between mb-1">
                                                                ...
                                                                <button onClick={() => copyToClipboard(outreachOption.linkedin?.subject || '', 'LinkedIn Subject')} className="text-xs text-blue-600 hover:underline flex items-center gap-1"><svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>Copy</button>
                                                            </div>
                                                            <p className="p-2 bg-white rounded border border-gray-200">{outreachOption.linkedin?.subject || 'Not available'}</p>
                                                        </div>
                                                        <div>
                                                            <div className="flex items-center justify-between mb-1">
                                                                <span className="font-semibold text-gray-600">Message:</span>
                                                                <button onClick={() => copyToClipboard(outreachOption.linkedin?.message || '', 'LinkedIn Message')} className="text-xs text-blue-600 hover:underline flex items-center gap-1"><svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>Copy</button>
                                                            </div>
                                                            <p className="p-2 bg-white rounded border border-gray-200 whitespace-pre-line">{outreachOption.linkedin?.message || 'Not available'}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className={`border border-gray-200 rounded-lg p-4 bg-gray-50`}>
                                                    <h3 className={`font-semibold text-gray-700 mb-3 flex items-center gap-2`}>
                                                        <svg className="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                                                        Email
                                                    </h3>
                                                    <div className="space-y-3 text-sm">
                                                        <div>
                                                            <div className="flex items-center justify-between mb-1">
                                                                <span className="font-semibold text-gray-600">Subject:</span>
                                                                <button onClick={() => copyToClipboard(outreachOption.email?.subject || '', 'Email Subject')} className="text-xs text-blue-600 hover:underline flex items-center gap-1"><svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>Copy</button>
                                                            </div>
                                                            <p className="p-2 bg-white rounded border border-gray-200">{outreachOption.email?.subject || 'Not available'}</p>
                                                        </div>
                                                        <div>
                                                            <div className="flex items-center justify-between mb-1">
                                                                <span className="font-semibold text-gray-600">Message:</span>
                                                                <button onClick={() => copyToClipboard(outreachOption.email?.message || '', 'Email Message')} className="text-xs text-blue-600 hover:underline flex items-center gap-1"><svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"></path></svg>Copy</button>
                                                            </div>
                                                            <p className="p-2 bg-white rounded border border-gray-200 whitespace-pre-line max-h-48 overflow-y-auto">{outreachOption.email?.message || 'Not available'}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
